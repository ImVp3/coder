...
from .utils.routing import decision_to_end_workflow
from .utils.helper import create_code_analysis_chain, create_test_generation_chain, create_evaluation_chain
...
class UnitTestWorkflow:
    ...
    def _create_graph(self) -> StateGraph:
        ...
        graph.add_edge(START, "analyze_code_node")
    ...
    def _wrap_decision(self, state: UnitTestWorkflowState):
        """Wrapper function to add logging to decision making"""
        decision = decision_to_end_workflow(state)
